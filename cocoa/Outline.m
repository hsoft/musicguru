...
/* Private */
- (NSImage *)addCircleWithCount:(NSInteger)aCount ofColor:(NSColor *)aColor withTextColor:(NSColor *)aTextColor toImage:(NSImage *)aImage
{
    NSImage *r = [[[NSImage alloc] initWithSize:[aImage size]] autorelease];
    NSString *s = [[NSNumber numberWithInt:aCount] stringValue];
    NSInteger circleWidth = 18;
    if ([s length] > 2)
...
- (void)mouseDragged:(NSEvent *)aEvent
{
    ...
    NSImage *cellImage = [self addCircleWithCount:[draggedNodes count] ofColor:circleColor 
